...
class ModeratorController extends Controller
{
    ...
    public function update(UpdateProfileRequest $request, Admin $admin)
    {
        ...
        return redirect()->route('moderator.show', $admin->unique)->with('success', 'Profile updated.');
    }
    ...
    public function uploadAvatar(UploadAvatarRequest $request, Admin $admin)
    {
        ...
        return redirect()->route('moderator.show', $admin->unique)->with('success', 'Profile pic uploaded.');
    }
